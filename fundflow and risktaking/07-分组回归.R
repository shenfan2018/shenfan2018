...
liner1<-data.net.1[,felm(r.total.c~netflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
data.net.2<-data.net[group.net==2,.SD]
liner2<-data.net.2[,felm(r.total.c~netflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
data.net.3<-data.net[group.net==3,.SD]
liner3<-data.net.3[,felm(r.total.c~netflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
...
liner4<-data.in.1[,felm(r.total.c~inflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
data.in.2<-data.in[group.in==2,.SD]
liner5<-data.in.2[,felm(r.total.c~inflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
data.in.3<-data.in[group.in==3,.SD]
liner6<-data.in.3[,felm(r.total.c~inflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
...
liner7<-data.out.1[,felm(r.total.c~outflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
data.out.2<-data.out[group.out==2,.SD]
liner8<-data.out.2[,felm(r.total.c~outflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
data.out.3<-data.out[group.out==3,.SD]
liner9<-data.out.3[,felm(r.total.c~outflow.1+logfund_size.1+logfund_age.1+period_return.1|code+DateQ)]
...
rm(data.net,data.net.1,data.net.2,data.net.3,data.in,data.in.1,data.in.2,data.in.3,data.out,data.out.1,data.out.2,data.out.3,a1,a2)
